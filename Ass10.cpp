...
#define CHECKUP 1 
using namespace std; 
string Q[N]; int Pr[N]; int r = -1, f = -1; 
...
cout << "Patient's Name - " << Q[i]; 
        ...
        case 1:             cout << " Priority - 'Checkup' " << endl; 
            ...
            break;         case 10:             cout << " Priority - 'Serious' " << endl; 
            break;         default: 
...
void dequeue() { // remove the data from front 
    ...
    { 
        cout << "deleted Element =" << Q[f] << endl;         cout << "Its Priority = " << Pr[f] << endl; 
        if (f == r)             f = r = -1; else 
            f++; 
    } 
} 
int main() 
{ 
    string data;     int opt = 0, p;     while (opt != 4) 
    { 
        ...
        case 1: 
            ...
            break;         case 2:             print();             break;         case 3:             dequeue();             break;         case 4: 
            cout << "***** Exited *****\n"; 
